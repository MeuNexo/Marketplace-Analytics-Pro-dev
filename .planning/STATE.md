...
last_activity_desc: "Ditado por voz via Gemini (quick 260729-r44) — E2E real em prod"
progress:
  total_phases: 50
  completed_phases: 30
  total_plans: 110
...
| 260729-r44 | Ditado por voz com transcrição no backend (EF transcribe-audio + Gemini flash): substitui a Web Speech API, que falhou no desktop (network, serviço de voz do Google bloqueado na rede) e no celular (sem resultado). E2E real em prod com áudio pt-BR: 200 + 403/415/400/413 provados. ~R$0,01/min. 764 testes, tsc 0, build ok | 2026-07-29 | (PR #37) | [260729-r44](./quick/260729-r44-transcricao-de-voz-via-gemini/) |
| 260729-qnv | Ditado por voz no chat do Nexo (Web Speech API, custo zero): botão de microfone com pt-BR, fala contínua e texto ao vivo; preserva o que já foi digitado; botão só aparece onde o navegador suporta. 750 testes, tsc 0, build ok | 2026-07-29 | (PR #35) | [260729-qnv](./quick/260729-qnv-ditado-por-voz-no-chat-do-nexo/) |
