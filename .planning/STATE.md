...
- **PENDENTE 53:** UI 53-02 (resumo no topo de /vendas + botão "Explicar" por insight — a EF já suporta via `prompt_version='explain:'+rule_key`, só falta o ramo de modo explain + a UI). Remover/blindar o smoke_token backdoor antes de produção real (hoje gated no vault SMOKE_TOKEN='pv-smoke-2026-53').
