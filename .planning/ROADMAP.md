...
- [ ] 78-01-PLAN.md — Shell + componentes compartilhados (MLPeriodPicker, OrganizationSwitcher/Header)
- [ ] 78-02-PLAN.md — Páginas Dashboard (Publicidade, Financeiro, Produtos Vendidos, Análise de Preços, Vendas)
