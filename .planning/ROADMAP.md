...
- [ ] 90-01-PLAN.md — Wave 1: colunas de triagem em ml_claims + helper compartilhado claimActions + wiring no ml-webhook/sync-ml-claims
- [ ] 90-02-PLAN.md — Wave 1: tabela ml_claim_templates (RLS org-first) + buyer_first_name no ml-claim-detail
- [ ] 90-03-PLAN.md — Wave 2: 3 baldes + selos + prazo + KPI "Pendem você" + sininho (depende de 90-01)
