...
- [ ] 77-01-PLAN.md — Camada de dados + migration: util soldProductsAgg (+testes), hook useMLSoldProducts, RPC orders_price_timeseries [BLOCKING push no banco real]
- [ ] 77-02-PLAN.md — UI: porte de PrecoPraticadoReport + páginas MLProdutosVendidos e MLAnalisePrecos
